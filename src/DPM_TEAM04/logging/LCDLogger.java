...
public class LCDLogger extends Thread {
	...
	public void run() {
		...
		while(!this.isInterrupted()) {
			...
			//We don't want entry providers to be added while they are being displayed
			synchronized (dataProviders) {
	...
	/**
	 * Converts a double into a formatted string with desired
	 * number of decimal places. This method is more suitable
	 * than printing the raw double as this can overflow a line
	 * on the EV3 LCD.
	 * 
	 * @param x the double to convert
	 * @param places the number of decimal places to truncate {@code x} to
